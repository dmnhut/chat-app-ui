...
public class ManyFriendsAdapter extends BaseAdapter {
    private int lastPosition = -1;
    private List<ManyFriends> listData;
    private LayoutInflater layoutInflater;
    private Context context;

    public ManyFriendsAdapter(List<ManyFriends> listData, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        final View result;
        if (view == null) {
            view = layoutInflater.inflate(R.layout.many_friends_item, null);
            holder = new Holder();
            holder.circleImageView = (CircleImageView) view.findViewById(R.id.imgGroup);
            holder.textView = (TextView) view.findViewById(R.id.nameGroup);
            result = view;
            view.setTag(holder);
        } else {
            result = view;
